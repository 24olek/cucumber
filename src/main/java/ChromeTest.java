...
import io.cucumber.messages.internal.com.fasterxml.jackson.databind.deser.std.StringArrayDeserializer;
...
public class ChromeTest {
    ...
    public void takeScreenshot(String number) throws Exception {
        ...
        File destination = new File("C:\\Users\\xyz\\Documents\\nauka\\screenshot" + number + ".jpg");
